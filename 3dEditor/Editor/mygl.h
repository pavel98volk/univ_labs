...
public:
   ...
   bool ctrl_pressed=false,shift_pressed=false,alt_pressed=false,z_pressed=false,color_pressed=false;//to determine if
...
public slots:
   void addSphere(bool a);
   void addCone(bool a);
   void addCylinder(bool a);
  signals:
